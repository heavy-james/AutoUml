...
public class UmlCreater {
    ...
    private void setUpCommonData() {
        ...
        if (urls != null) {
            for (URL url : urls) {
                LogUtil.v("UmlCreater", "setUpCommonData jar url-->" + url.toString());
            }
        } else {
            LogUtil.d("UmlCreater", "setUpCommonData jars empty");
        }
        ...
        for (Class<?> clazz : classes) {
            LogUtil.v("UmlCreater", "setUpCommonData result class-->" + clazz.getName());
        }
